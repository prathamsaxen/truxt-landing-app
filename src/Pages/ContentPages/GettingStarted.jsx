      ...
      <div className="content-layout">
        <section>
          ...
          <p>
            ...
            documentation. Teams at Docker, OpenAI, Reddit, and NextJS rely on Truxt to enhance
            their technical user experience and reduce support needs.
          </p>
        </section>
        <section>
          <h2>What is Truxt?</h2>
          <p>
            ...
            your product. Once set up, your Truxt instance will focus solely on your software. This
            is made possible through Truxt's retrieval augmented generation (RAG) system, designed
            to optimize technical question answering.
            <br />
            The Truxt.ai platform indexes all your technical knowledge sources and starts answering
            questions using your content. The most common use case for Truxt is deploying it
            directly to your developer community, where they can instantly find answers and solve
            problems faster.
          </p>
        </section>
        <section>
          ...
          <ul>
            <li>
              ...
              <span>
                ...
                technical knowledge sources. These pipelines connect to your data sources, pull
                their content, transform and index them using embeddings. Once your content has been
                indexed it is semantically searchable. These data pipelines also refresh your
                content periodically so it is always up to date.
              </span>
            </li>
            <li>
              ...
              <span>
                ...
                to your content which puts you in control and minimizes hallucinations. However,
                kapa can infer a complicated answer from multiple pieces of separate information.
              </span>
            </li>
            <li>
              ...
              <span>
                ...
                Kapa.ai bot that can either auto-reply to forum posts or respond when mentioned
                within Slack.
                <br /> For Discord, Kapa.ai offers a Discord Bot that provides similar
                functionality, automatically replying to forum posts or answering questions when
                mentioned. In customer support, the Zendesk Agent App integration allows you to use
                the Kapa Zendesk support app to reduce ticket resolution times by offering instant
                reply drafts.
                <br />
                Lastly, you can build on top of the Kapa.ai core infrastructure using the API to
                automatically answer technical questions, providing flexibility for developers
                looking to integrate it into their own systems.
              </span>
            </li>
          </ul>
        </section>
